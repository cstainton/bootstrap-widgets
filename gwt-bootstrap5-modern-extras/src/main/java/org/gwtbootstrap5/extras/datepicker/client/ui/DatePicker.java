...
public class DatePicker extends Div implements HasEnabled, HasId, HasName, HasPlaceholder,
    ...
    public void setVisibleOn(final DeviceSize deviceSize) {
        org.gwtbootstrap5.client.ui.base.helper.StyleHelper.setVisibleOn(this, deviceSize);
    }

    @Override
    public void setHiddenOn(final DeviceSize deviceSize) {
        org.gwtbootstrap5.client.ui.base.helper.StyleHelper.setHiddenOn(this, deviceSize);
    }
    ...
    private static native void bindChange(JavaScriptObject picker, DatePicker widget) /*-{
        picker.subscribe($wnd.tempusDominus.Namespace.events.change, function (e) {
            ...
            widget.@org.gwtbootstrap5.extras.datepicker.client.ui.DatePicker::onPickerChange(D)(d);
        });
    }-*/;
