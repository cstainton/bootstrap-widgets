 ...
 * #L%
 */
package org.gwtbootstrap5.extras.markdown.client.ui;
...
public class MarkdownEditor extends Div implements HasEnabled, HasId, HasValue<String>,
    ...
    private final Button writeTab = new Button("Write", ButtonType.DEFAULT);

    private final Button previewTab = new Button("Preview", ButtonType.DEFAULT);
    ...
    private ButtonGroup tabs() {
        ...
        group.addButton(writeTab);
        group.addButton(previewTab);
        return group;
    }
    ...
    public String getHTML() {
        return org.gwtbootstrap5.extras.markdown.client.Markdown.toHtml(getValue());
    }
