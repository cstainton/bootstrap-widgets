...
/** The jQuery build this module injects. */
public interface JQueryClientBundle extends ClientBundle {

    JQueryClientBundle INSTANCE = GWT.create(JQueryClientBundle.class);
