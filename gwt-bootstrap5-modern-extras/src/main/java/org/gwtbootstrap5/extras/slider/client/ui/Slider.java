 ...
 * #L%
 */
package org.gwtbootstrap5.extras.slider.client.ui;
 ...
 * noUiSlider 15.
 *
 * <p>For a plain single value, prefer {@link org.gwtbootstrap5.client.ui.Range}:
...
public class Slider extends Div implements HasEnabled, HasId, HasValueChangeHandlers<Double> {
    ...
    private static native void bindChange(JavaScriptObject slider, Slider widget) /*-{
        slider.on("update", function (values, handle) {
            widget.@org.gwtbootstrap5.extras.slider.client.ui.Slider::onSliderUpdate(D)(
