...
/**
 * Loads noUiSlider on the TeaVM backend.
 *
 * <p>The GWT module inlines the script through a ClientBundle and declares the stylesheet
 * in its {@code .gwt.xml}. TeaVM has neither mechanism, so both are fetched by URL. See
 * {@code MarkdownResources} for the same arrangement.</p>
 */
public final class SliderResources {

    private static final String SCRIPT = "nouislider-15.8.1.min.cache.js";
