...
[`teavm-bootstrap3`](../teavm-bootstrap3) or
[`teavm-bootstrap5`](../teavm-bootstrap5) and this comes with it.
...
[`teavm-gwt-compat-contracts`](../teavm-gwt-compat-contracts) runs a shared set of
assertions about GWT behaviour against this implementation. The same assertions run
against the real `gwt-user` in
[`gwt-bootstrap-widget-tests`](../../gwt/gwt-bootstrap-widget-tests) and
[`gwt-user-jvm-contract-tests`](../../gwt/gwt-user-jvm-contract-tests). A contract
