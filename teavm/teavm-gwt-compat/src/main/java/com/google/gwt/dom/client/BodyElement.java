 ...
 *
 * <p>GWT's {@code Document.getBody()} returns this rather than a plain element, and
 * shared code compiled against gwt-user carries that signature into the bytecode this
 * layer is linked against. Returning an {@code Element} instead therefore fails at
 * link time rather than at compile time, which is a slower way to find out.</p>
 */
