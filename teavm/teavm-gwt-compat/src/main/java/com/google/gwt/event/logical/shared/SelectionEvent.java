...
public class SelectionEvent<T> extends GwtEvent<SelectionHandler<T>> {
    ...
    protected SelectionEvent(T selectedItem) { this.selectedItem = selectedItem; }
    ...
    public static <T> Type<SelectionHandler<T>> getType() { return (Type) TYPE; }
    @Override public Type<SelectionHandler<T>> getAssociatedType() { return getType(); }
