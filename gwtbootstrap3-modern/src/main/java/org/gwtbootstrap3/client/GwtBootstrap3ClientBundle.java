...
/*
 * #%L
 * GwtBootstrap3 Modern
 * %%
 * Copyright (C) 2013 - 2016 GwtBootstrap3
 * Copyright (C) 2026 Graffica
 * %%
...
/**
 * Client-side script resources for the Bootstrap 5-backed compatibility fork.
 */
public interface GwtBootstrap3ClientBundle extends ClientBundle {
    ...
    @Source("resource/js/bootstrap5-jquery-compat.cache.js")
    TextResource bootstrapCompatibility();
}
