# GWT Bootstrap 3 Modern TeaVM Widget Backend
...
The target is a TeaVM-backed widget API that preserves the way users express Bootstrap 3 UI in Java, but without depending on UiBinder or GWT DOM classes. It uses the shared `gwt-teavm-compat` module for the small GWT client surface needed by TeaVM entry points and root panel integration.
