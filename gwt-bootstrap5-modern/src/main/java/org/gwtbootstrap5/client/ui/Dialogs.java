...
public final class Dialogs {
    ...
    public static void prompt(final String message, final String initialValue,
        ...
        modal.addShownHandler(new org.gwtbootstrap5.client.shared.event.ModalShownHandler() {
            @Override
            public void onShown(final org.gwtbootstrap5.client.shared.event.ModalShownEvent event) {
                input.setFocus(true);
            }
        });
        modal.addHiddenHandler(new ModalHiddenHandler() {
