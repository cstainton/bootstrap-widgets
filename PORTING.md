...
- Keep public package names, artifact IDs, and GWT module names stable for drop-in consumers.
...
- Use the TeaVM sidecar for experiments until the DOM/plugin seam is strong enough to support an alternate backend.
...
The TeaVM module is currently a sidecar, not a complete widget backend. The intended route is:
...
4. Only then consider compiling compatible widgets with TeaVM.
